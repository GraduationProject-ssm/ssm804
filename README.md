...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1xRe2eHEsa?p=5)


# 绪论
## 1.1 选题背景
当人们发现随着生产规模的不断扩大，人为计算方面才是一个巨大的短板，所以发明了各种计算设备，从结绳记事，到算筹，以及算盘，到如今的计算机，都是在无法满足生产的前提下出现的。随着计算机的发展，又出现了互联网技术。到现在为止，互联网已经发展了几十年了，在几十年的时间里就已经风靡世界。各行各业都发现了计算机的好处，计算机刚开始是军用的，后来在民用行业开始使用，到互联网时代，各种行业信息如井喷一般充斥着互联网，信息产生和传播的速度不断的提高。针对互联网的优点，结合互联网，对传统行业信息处理技术进行升级是非常有必要的。本课题对于学生宿舍设备报修信息的管理方面，开发一个学生宿舍设备报修管理系统，在信息管理方面不至于混乱，也能降低数据的出错率，数据安全方面也有了保证，该系统还有其他的优点，比如优化信息处理流程，降低信息泄露风险，减少资金投入，产出更高，让管理人员的工作更有效率等。所以说，学生宿舍设备报修管理系统是目前不可缺的，对使用者相当的重要。
## 1.2 选题意义
如今的年代，已经是步入信息社会了，不仅信息更新速度频繁，信息量也大，在信息时代必须有相应的处理信息的方法，如果还采用以前的结绳记事或者笔写纸记，不仅是信息录入效率上赶不上节奏，在信息检索的速度上更是让人无法承受。幸而当今社会上计算机技术发展的相当不错，可以通过计算机在信息处理上面实现自动化或者半自动化的作业，采用计算机技术，能有效的提高信息录入以及信息检索的效率，社会上相同行业之间本身就是效率高的淘汰效率低的，既然采用计算机来替代手工记录，必然是效率更高，稳定性更强，成本更低等诸多优点。针对于学生宿舍设备报修信息管理，开发一个学生宿舍设备报修管理系统不仅可以实现现代化的信息管理，也更符合现代化信息管理规范。

在实际的使用效果中，学生宿舍设备报修管理系统的意义如下：

第一点：学生宿舍设备报修管理系统的出现，就是为了提高工作人员的效率，能够在规定时间完成工作任务。
...
# 3 系统分析
对于学生宿舍设备报修管理系统开发设计到的流程有，分析系统的功能，设计系统的结构，设计数据库，编码以及测试，其中，在系统分析中，所做的工作包括功能的确定，性能的分析等。
## 3.1 可行性研究
学生宿舍设备报修管理系统开发实现分析需要从不同的角度来进行分析可行性，比如从时间角度，经济角度，甚至操作角度。从不同的角度分析可行性会让学生宿舍设备报修管理系统开发具体化，进而达到辩证开发的正确性。
### 3.1.1 经济可行性
从经济方面分析是第一要素，没有经济的支持，任何项目都如水中捞月，无法实现。实现学生宿舍设备报修管理系统，开发过程不需要额外的经济条件，用本人现有的计算机就可以实现，这方面不需要额外的支出。
### 3.1.2 时间可行性
学生宿舍设备报修管理系统设计主要作为毕业设计，在题目确定之后，答辩之前使用的项目，对不同的开发进度上面都有时间的要求，总不至于答辩完成后才能实现功能，这个肯定不行，所以从时间上来分析项目的工作量，发现是可行的，符合正常开发时间。
### 3.1.3 操作可行性
...
学生宿舍设备报修管理系统把操作该系统的用户群分为三类，即管理员，维修人员，学生。

管理员对于学生宿舍设备报修管理系统操作的功能包括对楼栋，公告类型，故障上报信息，宿舍信息，维修人员信息，学生信息以及宿舍人员信息等进行管理。其用例图如图3.4所示：

![](/md/blog.004.png)

图3.4 管理员用例图

维修人员对于学生宿舍设备报修管理系统操作的功能包括对故障上报信息进行接单，对故障物品进行维修，查看公告等。其用例图如图3.5所示：

![](/md/blog.005.png)

图3.5 维修人员用例图

学生对于学生宿舍设备报修管理系统操作的功能包括新增故障上报信息，查看宿舍和宿舍人员信息，查看公告等。其用例图如图3.6所示：
...
## 4.2 功能模块设计
对管理员具体功能的设计结果将以图4.1所示的管理员功能结构图来进行体现。管理员对于学生宿舍设备报修管理系统操作的功能包括对楼栋，公告类型，故障上报信息，宿舍信息，维修人员信息，学生信息以及宿舍人员信息等进行管理。

![](/md/blog.007.png)

图4.1 管理员功能结构图

对维修人员具体功能的设计结果将以图4.2所示的维修人员功能结构图来进行体现。维修人员对于学生宿舍设备报修管理系统操作的功能包括对故障上报信息进行接单，对故障物品进行维修，查看公告等。

![](/md/blog.008.png)

图4.2 维修人员功能结构图

对学生具体功能的设计结果将以图4.3所示的学生功能结构图来进行体现。学生对于学生宿舍设备报修管理系统操作的功能包括新增故障上报信息，查看宿舍和宿舍人员信息，查看公告等。
...
（1）学生包括的属性有学生姓名，手机号，照片等。其属性图如下。

![](/md/blog.010.png)

图4.4 学生实体属性图

（2）维修人员包括的属性有工作年限，照片，性别等。其属性图如下。

![](/md/blog.011.png)

图4.5 维修人员实体属性图

（3）故障上报包括的属性有故障分类，物品分类等。其属性图如下。

![](/md/blog.012.png)

图4.6 故障上报实体属性图

（4）宿舍包括的属性有宿舍号，宿舍位置等。其属性图如下。
...
|weixiuyuan\_id|维修人员|int(11)|是|
|guzhangshangbao\_uuid\_number|上报编号 |varchar(200)|是|
|wupin\_types|物品分类 |int(11)|是|
|guzhangshangbao\_types|故障分类 |int(11)|是|
|guzhangshangbao\_address|报修位置|varchar(200)|是|
|insert\_time|上报时间|timestamp|是|
|forum\_content|上报详情|text|是|
|weixiuzhuangtai\_types|维修状态 |int(11)|是|
|create\_time|创建时间|timestamp|是|
表4.3 宿舍表
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|loudong\_types|楼栋 |int(11)|否|
|danyuan\_types|单元 |int(11)|否|
|sushe\_uuid\_number|宿舍号 |varchar(200)|是|
|sushe\_address|宿舍位置 |varchar(200)|是|
|juzhu\_number|最大居住人数|int(11)|否|
...
|weixiuyuan\_uuid\_number|工号 |varchar(200)|是|
|weixiuyuan\_name|维修员姓名 |varchar(200)|是|
|sex\_types|性别|int(11)|是|
|weixiuyuan\_nianxian|工作年限|varchar(200)|是|
|weixiuyuan\_phone|联系方式|varchar(200)|是|
|weixiuyuan\_photo|照片|varchar(200)|是|
|weixiuyuan\_content|维修人员介绍|text|是|
|weixiuyuan\_delete|假删|int(11)|是|
|create\_time|创建时间|timestamp|是|
表4.7 学生表
...
| :-: | :-: | :-: | :-: |
|id (主键)|主键|int(11)|否|
|username|学号|varchar(200)|是|
|password|密码|varchar(200)|是|
|xuesheng\_uuid\_number|学号 |varchar(200)|是|
|xuesheng\_name|学生姓名 |varchar(200)|是|
|sex\_types|性别|int(11)|是|
|xuesheng\_id\_number|身份证号|varchar(200)|是|
|xuesheng\_phone|手机号|varchar(200)|是|
|xuesheng\_photo|照片|varchar(200)|是|
|create\_time|创建时间|timestamp|是|
...
## 5.1 管理员功能实现
### 5.1.1 宿舍管理
该功能主要用于实现对宿舍基本信息的管理，宿舍管理界面的运行效果见图5.1。在此界面，管理员添加宿舍号，最大居住人数等宿舍信息，对有错误数据的宿舍信息进行更改。

![](/md/blog.016.png)

图5.1 宿舍管理界面
### 5.1.2 宿舍人员管理
该功能主要用于实现对宿舍人员基本信息的管理，宿舍人员管理界面的运行效果见图5.2。在此界面，宿舍人员的基本信息，包括宿舍号，学生姓名，学号等信息需要管理员添加，管理员查询宿舍人员需要根据宿舍号或学号查询。

![](/md/blog.017.png)

图5.2 宿舍人员管理界面
### 5.1.3 维修人员管理
该功能主要用于实现对维修人员基本信息的管理，维修人员管理界面的运行效果见图5.3。在此界面，管理员对维修人员的工作年限，维修人员姓名，性别等信息进行添加，发现错误的维修人员数据可以修改。

![](/md/blog.018.png)

图5.3 维修人员管理界面
### 5.1.4 公告管理 
公告管理界面的运行效果见图5.4。在此界面，管理员发布公告，而维修人员和学生需要登录系统之后才可以查看公告。

![](/md/blog.019.png)

图5.4 公告管理界面
### 5.1.5 学生管理
该功能主要用于实现对学生基本信息的管理，学生管理界面的运行效果见图5.5。在此界面，管理员添加学生的姓名，身份证号等信息，发现有错误数据的学生信息可以使用修改功能及时更正。
...
## 5.2 维修人员功能实现
### 5.2.1 故障上报管理
该功能主要用于实现对故障上报基本信息的管理，故障上报管理界面的运行效果见图5.6。在此界面，维修人员对待接单的故障上报信息进行接单，待维修人员对故障物品维修好之后，维修人员需要设置故障上报信息为已维修状态。

![](/md/blog.021.png)

图5.6 故障上报管理界面
### 5.2.2 公告查看
公告查看界面的运行效果见图5.7。在此界面，维修人员查看公告具体内容。
...
## 5.3 学生功能实现
### 5.3.1 故障上报管理
故障上报管理界面的运行效果见图5.8。在此界面，学生新增故障上报信息，不仅需要登记故障分类，物品分类以及报修位置等信息。学生还可以修改故障上报信息，查询故障上报信息等。

![](/md/blog.023.png)

图5.8 故障上报管理界面
### 5.3.2 宿舍查看
宿舍查看界面的运行效果见图5.9。在此界面，学生查看宿舍详情，包括宿舍位置，宿舍最大居住人数等信息。

![](/md/blog.024.png)

图5.9 宿舍查看界面
### 5.3.3 宿舍人员查看
宿舍人员查看界面的运行效果见图5.10。在此界面，学生查看宿舍人员信息，以及查看宿舍人员详情信息。
